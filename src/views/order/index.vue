	...
	<div class="parkingSpace">
		<el-card class="box-card">
			...
			<el-table :data="tableData.data" style="width: 100%" size="small" highlight-current-row>
				...
				<!--					<template slot-scope="scope">-->
				<!--						<el-button v-if="scope.row.installer_id==0" type="text" size="small" class="mr10" @click="edit(scope.row)">分配安装人员</el-button>-->
				<!--					</template>-->
				<!--				</el-table-column>-->
			</el-table>
...
import { GetEbStoreOrderList } from '@/api/snack'
export default {
	name: 'index',
	data() {
		return {
